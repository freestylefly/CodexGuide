...
| <a href="https://apimart.ai/register?aff=oQgzUQ"><img src="https://raw.githubusercontent.com/freestylefly/awesome-gpt-image-2/main/data/images/sponsors/apimart.jpg" alt="APIMart" width="240"></a> | Thanks to APIMart for sponsoring this project! APIMart is a low-cost API platform for AI image and video generation—GPT-Image-2 from `$0.006/image`, with more than 160 images per dollar. One asynchronous API covers both image and video: submit a task, get an ID, and fetch results via polling or callback. Batch tens of thousands of images without timeouts and switch models without changing code. Pay as you go with no monthly fee—[sign up here](https://apimart.ai/register?aff=oQgzUQ) to get started. |
...
| <a href="https://ergouapi.com/r/gh-codexguide"><img src="./assets/sponsors/ergou-api.jpg" alt="Ergou API" width="240"></a> | Connect to Ergou for rock-solid reliability. [Ergou API](https://ergouapi.com/r/gh-codexguide) is an API relay platform offering ultra-low 0.1x–0.2x rates and 100% pure, original Claude / GPT / Grok and other international and Chinese model APIs.<br><br>Premium IPLC connectivity plus redundant residential dual-ISP routing ensures stable, low-latency access across China. Developers and studios are welcome to [sign up](https://ergouapi.com/r/gh-codexguide). |
