...
<div class="home-metric-grid">
  <a class="home-metric-card" href="/guide/00-overview" data-tone="teal">
    <strong>21 节 Codex 教程</strong>
    <span>从 Codex 桌面 App、费用理解、CLI、IDE 到 Cloud，按阶段建立完整使用习惯。</span>
  </a>
  ...
  <a class="home-metric-card" href="/configuration/" data-tone="amber">
    <strong>2 类 Codex 配置教程</strong>
    <span>覆盖 CLI 选项、config.toml 和项目规则配置。</span>
  </a>
...
<div class="home-path-grid">
  ...
  <a class="home-path-card" href="/guide/13-cli-installation" data-step="02">
  ...
  <a class="home-path-card" href="/configuration/" data-step="03">
    ...
    <span>理解 CLI 选项、config.toml、profile 和项目规则配置。</span>
    <em>适合准备长期使用 Codex 的个人和团队</em>
  </a>
  <a class="home-path-card" href="/guide/16-agents-md" data-step="04">
...
<div class="home-link-row">
  ...
  <a href="/guide/15-ide-vscode">VS Code 使用方式</a>
</div>

</div>

<img class="home-visual" src="https://cdn.canghecode.com/codexguide/docs/.vuepress/public/images/codex-surfaces.svg?v=20260611" alt="Codex 使用入口地图" loading="lazy" />
...
<div class="home-loop-grid">
  ...
  <a href="/guide/08-task-execution" class="home-loop-item" data-tone="blue">
    <strong>执行</strong>
    <span>理解 Codex 如何读文件、运行命令、小步修改和汇报状态。</span>
  </a>
  <a href="/guide/17-sandbox-approvals" class="home-loop-item" data-tone="rose">
    <strong>控制</strong>
...
<img class="home-wide-visual" src="https://cdn.canghecode.com/codexguide/docs/.vuepress/public/images/codex-workflow-loop.svg?v=20260611-2" alt="Codex 高质量任务闭环" loading="lazy" />
...
<img class="home-visual" src="https://cdn.canghecode.com/codexguide/docs/.vuepress/public/images/codex-safety-layers.svg" alt="Codex 安全边界分层" loading="lazy" />
...
<ul class="home-check-list">
  <li>用 <a href="/guide/16-agents-md">AGENTS.md</a> 写清项目命令、代码风格和禁止事项。</li>
  <li>用 <a href="/guide/17-sandbox-approvals">沙盒与审批</a> 管理文件、网络、凭据和高风险命令。</li>
  <li>用 <a href="/guide/18-thread-management">自动线程管理</a> 区分继续、分叉、移交和代码隔离场景。</li>
  <li>用 <a href="/practice/team-playbook">团队 playbook</a> 统一任务模板、复盘结构和案例沉淀。</li>
  <li>用 <a href="/guide/21-troubleshooting">排障手册</a> 快速定位登录、权限、依赖和执行异常。</li>
</ul>
