...
| [Ducksss/codex-profiles](https://github.com/Ducksss/codex-profiles) | Ducksss | 社区工具，为 Codex CLI 和命名 ChatGPT Desktop 窗口选择独立本地状态；最后核对日期：2026-07-13 | [18 Codex × codex-profiles](../recipes/18-codex-profiles.md) |
