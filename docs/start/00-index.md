...
7. [任务设计](./07-task-design.md)
8. [任务执行与验证闭环](./08-task-execution.md)
9. [用手机远程操控 Codex](./09-mobile-control.md)
...
如果你是个终端迷，那么CLI是一个合适的选择。特别是你有 [Vim](https://www.vim.org/) 基础，喜欢折腾快捷键映射，配合类似于 [tmux](https://github.com/tmux/tmux/wiki) 的终端复用工具，你可以在你熟悉的环境中更高效地使用 Codex。

如果你更习惯在IDE的环境中开发，或者希望完全托管到云端中，那么IDE或Cloud是更好的选择。

1. [安装CLI](./10-cli-installation.md)
2. [运行 CLI](./11-cli-first-run.md)
3. [CLI 选项与命令](./12-cli-options.md)
4. [在 VS Code 中使用 Codex](./13-ide-vscode.md)
5. [使用 Codex Cloud](./14-cloud.md)
...
如果你学有余力，可以尝试阅读 [进阶教程](../advanced/00-index.md)。这是非常具备技术含量的文档，能让你更进一步了解这个工具，充分发掘它的潜力，解放生产力。

## 下一步

下一步：[Codex 是什么](./01-what-is-codex.md)。
