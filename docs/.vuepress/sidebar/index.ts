...
export default sidebar({
  "/guide/": [
    ...
    },
    {
      ...
      expanded: false,
      children: [
        { text: "07 任务执行", link: "07-task-execution.md" },
        { text: "08 权限管理", link: "08-permissions.md" },
        { text: "09 技能与插件", link: "09-skills-plugins.md" },
        { text: "10 自动化", link: "10-automation.md" },
        { text: "11 桌面宠物", link: "11-desktop-pet.md" },
      ],
    },
    {
      text: "CLI 与 IDE",
      ...
      expanded: false,
      children: [
        { text: "12 CLI 安装与登录", link: "12-cli-installation.md" },
        { text: "13 CLI 改代码", link: "13-cli-first-run.md" },
        { text: "14 VS Code 插件", link: "14-ide-vscode.md" },
      ],
    },
    {
      text: "进阶与团队",
      ...
      children: [
        ...
        { text: "16 沙盒与审批", link: "16-sandbox-approvals.md" },
        { text: "17 Codex Cloud", link: "17-cloud-ide-app.md" },
        { text: "18 排障手册", link: "18-troubleshooting.md" },
      ],
    },
  ],
