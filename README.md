...
| <a href="https://ergouapi.com/r/gh-codexguide"><img src="./assets/sponsors/ergou-api.jpg" alt="二狗 API" width="240"></a> | 接入二狗，稳如老狗。[二狗 API](https://ergouapi.com/r/gh-codexguide) 中转站，全站 0.1x～0.2x 超低倍率，提供 Claude / GPT / Grok 等多个国内外 100% 纯血大模型接口。<br><br>顶级 IPLC 线路 + 住宅双 ISP 冗余，确保全国范围稳定低延迟访问。欢迎各位开发者、工作室 [注册使用](https://ergouapi.com/r/gh-codexguide)。 |
